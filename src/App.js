  ...
  shuffleScoreCard = id => {
    ...
    if (clickedPuppyIds.includes(id)) {
      ...
      if (clickedPuppyIds.length === 8) {
        this.setState({
          score: 8,
          status: "Winner! Click to play again!",
          clickedPuppyIds: []
        });
        console.log("You Win");
        return;
    ...
    return (
      <div className="App">
        <header className="App-header">
          <h1 className="App-title">Pokemon Matching Game</h1>
          <p className="App-intro">Avoid clicking the same Pokemon image twice.</p>
        </header>
        ...
        <footer>
          <p>
            App by Jack Dempsey. You can find the code
            <a
              href="https://github.com/jdempsey1993/Clicky-Game"
              target="_blank"
